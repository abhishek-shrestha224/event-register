...
public class GlobalExceptionHandler {
  ...
  public ErrorResponseDto<String> handleInvalidFileException(
      InvalidFileException ex, WebRequest req) {
  ...
  public ResponseEntity<ErrorResponseDto<String>> handleResponseStatusException(
  ...
  public ErrorResponseDto<Map<String, String>> handleValidationErrors(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ErrorResponseDto<String> handleInvalidPathParams(
