...
public class MailServiceImpl implements MailService {
    ...
    @Override
    @Async
    public void sendMailWithAttachment(final String to, final String subject, final String text, final byte[] attachment) {
        try {
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Error while sending mail with attachment.", ex);
        }
    }
}
